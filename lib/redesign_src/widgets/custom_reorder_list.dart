...
import 'package:image_picker_plus/redesign_src/widgets/reorder_list.dart';
...
/// [CustomReorderableListView.buildDefaultDragHandles].
///
/// All list items must have a key.
///
/// This example demonstrates using the [CustomReorderableListView.proxyDecorator] callback
/// to customize the appearance of a list item while it's being dragged.
///
/// {@tool dartpad}
/// While a drag is underway, the widget returned by the [CustomReorderableListView.proxyDecorator]
/// callback serves as a "proxy" (a substitute) for the item in the list. The proxy is
/// created with the original list item as its child. The [CustomReorderableListView.proxyDecorator]
...
/// {@end-tool}
///
/// This example demonstrates using the [CustomReorderableListView.proxyDecorator] callback to
...
/// its elevation. This example demonstrates how to use the [CustomReorderableListView.proxyDecorator]
...
class CustomReorderableListView extends StatefulWidget {
  ...
  /// created in advance, or all at once when the [CustomReorderableListView] itself
  /// is created, it is more efficient to use the [CustomReorderableListView]
  ...
  /// See also:
  ///
  ///   * [CustomReorderableListView], which allows you to build a reorderable
  ...
  /// wrapped by a [CustomReorderableDragStartListener]. On mobile
  ...
  /// each list item, with [CustomReorderableDragStartListener] or
  /// [CustomReorderableDelayedDragStartListener], or a custom subclass
  /// of [CustomReorderableDragStartListener].
  ///
